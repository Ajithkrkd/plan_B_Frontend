      ...
      <div className="relative">
        ...
        <div className=" d-flex items-center header">
          ...
          <div className="col d-flex align-items-center ">
            ...
            <img src={Logo} className="keep-img" rel="logo" />
            <h5
            ...
            {role === "ROLE_MEMBER" ? (
              <>
                ...
                <Link to={"/work-life-cycle"}>
                  <li className="">
                    <i className="bx bxs-time p-0 btn text-gray-400 text-[20px]" />
                    Work-Cycle
                  </li>
                </Link>
                <Link to={"/community"}>
              ...
              <>
                ...
                <Link to={"/admin/projects"}>
                  <li className="">
                    <i className="bx bx-task p-0 btn text-gray-400 text-[20px]" />
                    Projects
                  </li>
                </Link>
                <Link to={"/admin/users"}>
                ...
                <Link to={"/profile-settings"}>
                  <li className="">
                    <i className="bx bxs-user p-0 btn text-gray-400 text-[20px]" />
                    Profile
                  </li>
                </Link>
              </>
